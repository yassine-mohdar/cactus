    ...
    <div class="relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-10">
        <div class="auth-panel w-full max-w-xl px-8 py-10 sm:px-10">
            <div class="mb-8">
                ...
                <h1 class="mt-6 text-3xl font-extrabold tracking-[-0.04em] text-[#17302A]">Choose a new password.</h1>
                <p class="mt-2 text-sm leading-6 text-[#5D6F66]">This resets access for the staff account linked to the email below.</p>
            </div>
            ...
            <form method="POST" action="{{ route('password.update') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input id="email" type="email" name="email" value="{{ old('email', $request->email) }}" required autofocus class="input-field bg-[#F3EFE6] text-[#617169]" readonly>
                    @error('email')
