        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                <x-admin.card title="Category Details">
                    <div class="space-y-4">
                        ...
                        <x-admin.input name="slug" label="Slug" :value="old('slug')" placeholder="auto-generated-from-name" />
                        
                        <div>
                            <label class="block text-[10px] uppercase font-bold text-slate-500 tracking-widest mb-1">Description</label>
                            <x-admin.textarea name="description" rows="4">{{ old('description') }}</x-admin.textarea>
                            @error('description')
            ...
            <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="pt-2">
                            <label class="flex items-center space-x-2">
                                <input type="checkbox" name="is_active" value="1" @checked(old('is_active', true)) class="rounded border-slate-300 text-slate-900 focus:ring-slate-900">
                ...
                <x-admin.card title="Media">
                    <div class="space-y-4">
                        <div>
                            <label class="block text-[10px] uppercase font-bold text-slate-500 tracking-widest mb-1">Category Image</label>
