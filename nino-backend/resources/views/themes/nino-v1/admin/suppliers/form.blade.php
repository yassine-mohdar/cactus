<div class="space-y-4">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        {{-- Name --}}
        <div>
            <label for="name" class="block text-xs font-semibold text-slate-500 mb-1 uppercase tracking-widest">Supplier Name</label>
    ...
    <div>
        ...
        <textarea name="address" id="address" rows="2"
                  class="w-full rounded-md border-slate-200 bg-slate-50/5 text-slate-900 focus:border-slate-400 focus:ring-slate-400/20 transition-all">{{ old('address', $supplier->address) }}</textarea>
