...
@section('header')
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-slate-900 mt-2 tracking-tight">New Branch</h1>
        <p class="text-xs text-slate-500 mt-1">Register a new physical branch or warehouse location.</p>
    </div>
@endsection
