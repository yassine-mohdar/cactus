    ...
    public function registerAdminMenu(MenuRegistry $registry): void
    {
        $registry->add(
            MenuItem::make('commerce_header')
                ->setLabel('Commerce')
                ->asHeader()
                ->prioritizeForRoles([Role::SEO_CONTENT_MANAGER, Role::MARKETING_MANAGER, Role::STOCK_MANAGER], 75)
                ->setOrder(10)
        );
        ...
        $registry->add(
            MenuItem::make('catalog.categories')
                ...
                ->requirePermission('categories.viewAny')
                ->prioritizeForRoles([Role::SEO_CONTENT_MANAGER, Role::MARKETING_MANAGER], 75)
        ...
        $registry->add(
            MenuItem::make('catalog.products')
                ...
                ->requirePermission('products.viewAny')
                ->prioritizeForRoles([Role::SEO_CONTENT_MANAGER, Role::MARKETING_MANAGER, Role::STOCK_MANAGER], 75)
