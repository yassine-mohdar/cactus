    ...
    public function registerAdminMenu(MenuRegistry $registry): void
    {
        ...
        $registry->add(
            MenuItem::make('iam.staff')
                ...
                // Wait! Since policy is bound to the User model, can we just use Gate string or model array?
                // The current Sidebar does @can('viewAny', App\Models\User::class). Let's just use 'users.viewAny' which Spatie intercepts.
