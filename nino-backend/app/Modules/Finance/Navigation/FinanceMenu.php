    ...
    public function registerAdminMenu(MenuRegistry $registry): void
    {
        $registry->add(
            MenuItem::make('finance_header')
                ->setLabel('Finance')
                ->asHeader()
                ->prioritizeForRoles([Role::FINANCE_MANAGER], 85)
                ->setOrder(60)
        );
        ...
        $registry->add(
            MenuItem::make('finance.transactions')
                ...
                ->requirePermission(['finance.viewAny', 'payments.viewAny'])
                ->prioritizeForRoles([Role::FINANCE_MANAGER], 85)
        ...
        $registry->add(
            MenuItem::make('finance.refunds')
                ...
                ->requirePermission(['finance.viewAny', 'payments.refund'])
                ->prioritizeForRoles([Role::FINANCE_MANAGER], 85)
        ...
        $registry->add(
            MenuItem::make('finance.reports')
                ...
                ->requirePermission('finance.viewAny')
                ->prioritizeForRoles([Role::FINANCE_MANAGER], 85)
